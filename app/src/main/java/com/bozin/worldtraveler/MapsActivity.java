 ...
 */
public class MapsActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener, MapFragment.MapFragmentStatisticsListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setBackgroundColor(ContextCompat.getColor(MapsActivity.this, R.color.colorPrimaryDark));
        toolbar.setTitleTextColor(ContextCompat.getColor(MapsActivity.this, R.color.textWhite));


        mDrawerLayout = findViewById(R.id.drawer_layout);

        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(MapsActivity.this, mDrawerLayout, R.string.open_drawer, R.string.closed_drawer);
